...
>deployedContract = new VotingContract.new(['Aashay','Akshat'],{data: byteCode, from: web3.eth.accounts[0], gas: 4700000})
...
```
> contractInstance.totalVotesFor.call('Aashay').toLocaleString()
'2'
```
